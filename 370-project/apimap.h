...
public:
    ...
    void fetchWalkingRoute(const QList<QGeoCoordinate> &points);
    ...
    void removeAllMap();
    void addInfoToMap(const QGeoCoordinate &coord, const QString &name, const QString &building);
    void removeInfoMap(const QGeoCoordinate &coord, const QString &name, const QString &building);
...
signals:
    ...
    void mapRoute(const QList<QGeoCoordinate> &points);
    void routeReady(const QVariantList &routeCooords);
    void noRoute();
...
private:
    ...
    QList<QGeoCoordinate> schedule_;
};
